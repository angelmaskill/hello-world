...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
 ...
 /*   public static void main(String[] args) {
     ...
     * @author ShenZengguo 16:10 2018/10/12
     **/
     ...
     * @param s
     * @return java.lang.String
     * @author ShenZengguo 16:11 2018/10/12
     **/
     ...
     * @return
     */
    public static String mergeAndCoverJsonStr(String sourceJsonStr, String coverJsonStr) {
        JSONObject sourceJson = parseJsonStr(sourceJsonStr);
        JSONObject coverJson = parseJsonStr(coverJsonStr);
        JSONObject mergedJson = mergeAndCoverJson(sourceJson, coverJson);
        return mergedJson == null ? "" : mergedJson.toJSONString();
    }
     ...
     * @return
     */
    public static String expandJson(String json, String key, String value) {
    ...
    public static boolean isInteger(String value) {
        Pattern patterns = Pattern.compile("[1-9]\\d*");
